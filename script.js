...
const gameData = {
    "server_room_front": {
        ...
        items: [
            { type: "inspectable", id: "CL-01", name: "屍體輪廓", content: "索恩博士倒臥於此，死狀痛苦。", detail: "【深層分析】皮膚呈現異常青紫色，檢測出高濃度河豚毒素殘留。", price: 2, icon: "https://cdn-icons-png.flaticon.com/512/3063/3063176.png", style: { top: "65%", left: "53%", width: "200px", height: "120px", background: "rgba(255, 255, 255, 0.1)", borderRadius: "30% 70% 70% 30% / 30% 30% 70% 70%", transform: "rotate(-10deg)" } },
            { type: "special", id: "console", name: "被封鎖的伺服器", trigger: "sophie_alert", style: { top: "25%", left: "32%", width: "180px", height: "300px", border: "2px dashed yellow", background: "rgba(255, 255, 0, 0.1)" } },
            { type: "inspectable", id: "CL-99_papers", name: "散落的文件", content: "博士倒下前似乎緊抓著這些文件。", detail: "是一份加密的物流清單。你注意到上面有一筆異常的「深海探測器原型機」出貨紀錄，旁邊有安保主管 Marcus 的電子簽章。", price: 3, style: { top: "82%", left: "72%", width: "120px", height: "80px", background: "rgba(255, 255, 255, 0.15)", borderRadius: "5px" } }
        ]
    },
...
function confirmCharacter() { 
    ...
    document.getElementById('private-mission').innerText=char.mission; 
    document.getElementById('private-script-modal').style.display='flex'; 
    document.getElementById('tab-role').innerHTML=`<p><strong>${char.name}</strong></p><p>${char.full_story}</p><p><strong>任務：</strong>${char.mission}</p>`; 
}
